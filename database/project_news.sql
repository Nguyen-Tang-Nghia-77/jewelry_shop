...
-- Thời gian đã tạo: Th10 15, 2023 lúc 01:46 PM
...
CREATE TABLE `categories` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_home` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
  `display` enum('list','grid') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'list'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `categories` (`id`, `name`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `is_home`, `display`) VALUES
(1, 'Thể thao', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-11 17:00:00', 'yes', 'list'),
(2, 'Giáo dục', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-11 17:00:00', 'yes', 'grid'),
(3, 'Sức khỏe', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-15 08:04:33', 'no', 'list'),
(4, 'Du lịch', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-15 08:04:30', 'no', 'grid'),
(5, 'Khoa học', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-11 17:00:00', 'no', 'list'),
(6, 'Số hóa', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-15 08:04:38', 'no', 'grid'),
(7, 'Xe - Ô tô', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-15 08:04:36', 'yes', 'list'),
(8, 'Kinh doanh', 'active', 'hailan', 'hailan', '2019-05-11 17:00:00', '2023-11-01 17:00:00', 'yes', 'list');
...
CREATE TABLE `menu` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_open` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `menu` (`id`, `name`, `link`, `type`, `type_open`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'Thể thao', 'http://proj_news.test/news/chuyen-muc/the-thao-1.html', 'category_news', '_self', 'active', 'admin', 'hailan', '2023-11-13 07:03:10', '2023-11-12 17:00:00'),
(3, 'Giáo dục', 'http://proj_news.test/news/chuyen-muc/giao-duc-2.html', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(4, 'Sức khỏe', 'http://proj_news.test/news/chuyen-muc/suc-khoe-3.html', 'category_news', '_self', 'inactive', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(5, 'Du lịch', 'http://proj_news.test/news/chuyen-muc/du-lich-4.html', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(6, 'Khoa học', 'http://proj_news.test/news/chuyen-muc/khoa-hoc-5.html', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(7, 'Số hóa', 'http://proj_news.test/news/chuyen-muc/so-hoa-6.html', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(8, 'Xe - Ô tô', 'http://proj_news.test/news/chuyen-muc/xe-o-to-7.html', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(9, 'Kinh doanh', 'http://proj_news.test/news/chuyen-muc/kinh-doanh-8.html', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL),
(10, 'Tin tức tổng hợp', 'http://proj_news.test/news/tin-tuc-tong-hop', 'category_news', '_self', 'active', 'hailan', NULL, '2023-11-12 17:00:00', NULL);
...
INSERT INTO `rss` (`id`, `name`, `ordering`, `link`, `source`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'Thế Giới VNExpress', 1, 'https://vnexpress.net/rss/the-gioi.rss', 'vnexpress', 'active', 'hailan', 'hailan', '2021-07-10 17:00:00', '2021-07-11 17:00:00'),
(2, 'Thế Giới TuoiTre', 2, 'https://tuoitre.vn/rss/the-gioi.rss', 'tuoitre', 'active', 'hailan', NULL, '2021-07-10 17:00:00', NULL),
(4, 'Thời sự VNEx', 4, 'https://vnexpress.net/rss/thoi-su.rss', 'vnexpress', 'active', 'hailan', 'hailan', '2021-07-11 17:00:00', '2021-07-11 17:00:00');
...
CREATE TABLE `users` (
  ...
  `level` enum('admin','member') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `users` (`id`, `username`, `email`, `fullname`, `password`, `avatar`, `level`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin@gmail.com', 'admin123456', 'e10adc3949ba59abbe56e057f20f883e', '1ctW8mj8vq.png', 'admin', 'active', 'admin', 'hailan', '2014-12-10 01:55:35', '2019-05-04 07:47:14'),
(2, 'hailan', 'hailan@gmail.com', 'hailan', '7c6f3ef49405d8a330aaa19ca0d0f6af', '1eSGmvZ3gM.jpeg', 'admin', 'active', 'admin', 'hailan', '2014-12-13 00:20:03', '2019-05-04 01:47:04'),
(3, 'user123', 'test@gmail.com', 'user123', 'e10adc3949ba59abbe56e057f20f883e', 'Hb1QSn1CL8.png', 'admin', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2019-05-04 01:47:07'),
(4, 'user456123', 'user456@gmail.com', 'user456', 'e10adc3949ba59abbe56e057f20f883e', 'J1uknUz0T6.png', 'member', 'active', 'admin', 'hailan', '2019-05-03 17:00:00', '2023-11-05 17:00:00'),
(5, 'zyfumobo', 'fahinunufe@mailinator.com', 'Hayley Stanley', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 'tOUvY3M5BH.jpg', 'admin', 'active', 'hailan', NULL, '2023-11-05 17:00:00', NULL);
