        ...
        <table class="table table-bordered table-hover text-nowrap btn-table mb-0">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Info</a></th>
                    <th class="text-center">Type</a></th>
                    <th class="text-center">Type open</a></th>
            ...
            <tbody>
                ...
                @foreach ($items as $key => $val)
                    @php
                        ...
                        $typeOpen               = Hightlight::show($val['type_open'], $params['search'], 'type_open');
                    ...
                    <tr class="{{ $class }}">
                        ...
                        <td width="20%">
                            ...
                            <p class="mb-0"><strong>Link:</strong>{!! $link !!}</p>
                        </td>
                        
                        <td class="text-center align-middle">{{ $type }}</td>
                        <td class="text-center align-middle">{{ $typeOpen }}</td>
