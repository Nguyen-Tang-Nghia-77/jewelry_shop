$(document).ready(function () {
    ...
    let outputNestable = $('#output-nestable');
    categoryTree.nestable({ /* config options */ }).on('change', function() {
        let dataSend = categoryTree.nestable('serialize');
        outputNestable.val(JSON.stringify(dataSend));
        console.log(categoryTree.data('url'));
        $.ajax({
            type: "post",
    ...
    // outputNestable.val(JSON.stringify(categoryTree.nestable('serialize')));
