...
class ArticleController extends Controller
{
    ...
    public function form(Request $request)
    {
        ...
        $categoryModel  = new CategoryModel();
        $itemsCategory  = $categoryModel::withDepth()->having('depth', '>', 0)->defaultOrder()->get()->toFlatTree()->pluck('name_with_depth', 'id');
    ...
    {
        $params["currentCategoryId"]   = $request->category_id;
        $params["id"]               = $request->id;
        $this->model->saveItem($params, ['task' => 'change-category-id']);
        return response()->json([
            'status' => 'success'
        ]);
    }
