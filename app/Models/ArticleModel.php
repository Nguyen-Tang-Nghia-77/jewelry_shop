...
class ArticleModel extends AdminModel
{
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-list-items") {
            $query = $this->select('a.id', 'a.name', 'a.status', 'a.content', 'a.thumb', 'a.type', 'a.category_id', 'c.name as category_name')
    ...
    public function saveItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'change-category-id') {
            self::where('id', $params['id'])->update(['category_id' => $params['currentCategoryId']]);
        }
